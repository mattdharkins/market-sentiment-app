...
from market_sentiment.forms import UserLoginForm, UserSignupForm
from market_sentiment.models import User,db, check_password_hash
    ...
    try:
        if request.method == 'POST' and form.validate_on_submit():
            ...
            if logged_user and check_password_hash(logged_user.password, password):
                ...
                return redirect(url_for('site.market_sentiment'))
            else:
